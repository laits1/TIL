...
token = "ODkzNjg2ODY4OTA0OTAyNjU2.YVfEwQ.vv-A12rzY7ubW7xjNuuMH2HlIOM"
riot_token = "RGAPI-d0b5a6b4-8534-4491-9d32-74a9b6075b3c"
...
async def on_message(message):
    if message.content.startswith("/검색 "):
        ...
        if res.status_code == 200:
            ...
            if resjs['name'] == '잔나 is OP' :

                embed = discord.Embed(title=f"초고수 동구 {resjs['name']} 님의 플레이어 정보", description=f"**{resjs['summonerLevel']} LEVEL**", color=0xFF9900)
            else :
