...
# f1=open("Python_basic/file/test.txt",'r', encoding='utf_8') #ansi  형태의 파일
...
# 2개 파일객체 필요
f2= open("Python_basic/file/test.txt","r", encoding='utf-8') #원본 : 읽어올 파일 객체
f3 = open("Python_basic/file/test_write.txt","a",encoding='utf-8')
